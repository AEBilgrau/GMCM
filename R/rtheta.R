...
#'   follows. The new behaviour is inspired by the simulation scenarios in Friedman
#'   (1989) but not always the same.
#'   \itemize{
#'   \item{\code{pie}
#'     is generated by \eqn{m} draws of a chi-squared distribution with \eqn{3m}
...
#'   \item{\code{sigma}}{
#'     is dependent on \code{method}. Ehe covariance matrices for each
...
#'     \item{\code{"UnequalSpherical"}, then the covariance matrices are scaled
#'       identity matrices. In component \eqn{h}, the covariance matrix is
#'       \eqn{hI}}
...
#'       the interval \eqn{10} to \eqn{1} and a randomly (uniformly) oriented
...
#'     \item{\code{"old"}, then the old behaviour is used.
